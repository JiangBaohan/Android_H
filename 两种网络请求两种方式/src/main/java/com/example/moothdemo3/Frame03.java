...
public class Frame03 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        xlist = (XListView) view.findViewById(R.id.fragment03_list);
            ...
            if (view == null) {
                switch (type) {
                    case FristType:
                        ...
                        view = View.inflate(getActivity(), R.layout.fragment03_holder, null);
                        holder01.tv1 = (TextView) view.findViewById(R.id.fagment03_text1);
                        holder01.iv1 = (ImageView) view.findViewById(R.id.fragment03_image1);
                        view.setTag(holder01);
                        break;
                    case TwoType:

                        holder02 = new ViewHolder02();
                        view = View.inflate(getActivity(), R.layout.fragment03_holder2, null);
                        holder02.tv2 = (TextView) view.findViewById(R.id.fagment03_text2);
                        holder02.iv2 = (ImageView) view.findViewById(R.id.fragment03_image2);
